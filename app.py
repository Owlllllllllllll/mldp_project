...
st.markdown("""Attribution:
            <a href="https://www.vecteezy.com/free-videos/happy-background">Happy Background Stock Videos by Vecteezy</a>
            """, unsafe_allow_html=True)
